...
- **ストリーマーモード:** これを有効にすると、ロビーコードが TheOtherRolesGM KM に置き換えられ、カスタムサーバー欄の文字が伏せられます。ロビーコードを隠す文字は AmongUs/BepInEx/config フォルダ内の「me.eisbison.theotherroles.cfg」で変更できます。
